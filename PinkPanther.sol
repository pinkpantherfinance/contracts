...
/**
   ...
   Rfi,Feg,CT,Safemoon,Pig combine together to creat PANTHER designed.
    
    I make this #PANTHER to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/pinkpanthermoon
   ...
   I will renounce the ownership to burn addresses to transfer #PANTHER to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 50% total supply to the pool
   Can you make #PANTHER 100000X? 

   100,000,000,000,000,000 total supply
   500,000,000,000,000 PANTHER max limit for per trade
   ...
   it's the best part of the #PANTHER idea, increasing the liquidity pool automatically, 
...
contract PinkPanther is Context, IERC20, Ownable {
    ...
    string private _name = "Pink Panther";
    string private _symbol = "PANTHER";
